...
Route::middleware(['auth:sanctum', \App\Http\Middleware\ConfineEventAgent::class])->group(function () {
    ...
    Route::middleware('role:admin,secretaire')->group(function () {
        ...
        Route::post('/occasions/{occasion}/ticket-design', [OccasionController::class, 'uploadTicketDesign']);
        Route::delete('/occasions/{occasion}/ticket-design', [OccasionController::class, 'removeTicketDesign']);
        ...
        Route::post('/occasions/{occasion}/guests/bulk-delete', [GuestController::class, 'bulkDestroy']);
        Route::post('/occasions/{occasion}/guests/bulk-mark-invited', [GuestController::class, 'bulkMarkInvited']);
